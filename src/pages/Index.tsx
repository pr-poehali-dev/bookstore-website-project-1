...
const BOOKS = [
  { id: 1, title: "Мастер и Маргарита", author: "Михаил Булгаков", genre: "Классика", price: "520 ₽", year: 1967, desc: "Философский роман о добре и зле, любви и творчестве — один из главных текстов XX века", rating: 5, badge: "Хит" },
  { id: 2, title: "Преступление и наказание", author: "Фёдор Достоевский", genre: "Классика", price: "490 ₽", year: 1866, desc: "Психологический роман о нравственных терзаниях и поиске истины", rating: 5, badge: "" },
  { id: 3, title: "Лавр", author: "Евгений Водолазкин", genre: "Современная", price: "580 ₽", year: 2012, desc: "Неисторический роман о средневековом целителе, ищущем спасения и смысла жизни", rating: 5, badge: "Популярное" },
  { id: 4, title: "Зулейха открывает глаза", author: "Гузель Яхина", genre: "Современная", price: "540 ₽", year: 2015, desc: "История татарской женщины, сосланной в Сибирь, — о силе воли и праве на жизнь", rating: 5, badge: "Бестселлер" },
  { id: 5, title: "Обитель", author: "Захар Прилепин", genre: "Современная", price: "610 ₽", year: 2014, desc: "Роман о Соловецком лагере 1920-х годов — жестокий и пронзительный", rating: 5, badge: "" },
  { id: 6, title: "Текст", author: "Дмитрий Глуховский", genre: "Современная", price: "480 ₽", year: 2017, desc: "Острый психологический триллер о мести, цифровой идентичности и цене справедливости", rating: 4, badge: "Новинка" },
  { id: 7, title: "Петровы в гриппе", author: "Алексей Сальников", genre: "Современная", price: "460 ₽", year: 2016, desc: "Магический реализм о буднях уральской семьи — смешной, страшный и очень русский", rating: 4, badge: "" },
  { id: 8, title: "Чёрная обезьяна", author: "Захар Прилепин", genre: "Современная", price: "430 ₽", year: 2011, desc: "Мрачный роман-расследование о насилии, детстве и распаде человека", rating: 4, badge: "" },
  { id: 9, title: "Авиатор", author: "Евгений Водолазкин", genre: "Современная", price: "560 ₽", year: 2016, desc: "Человек просыпается в 1999 году, не помня ничего, кроме начала XX века", rating: 5, badge: "" },
  { id: 10, title: "Дни Савелия", author: "Григорий Служитель", genre: "Современная", price: "420 ₽", year: 2019, desc: "Нежный роман о московском коте, написанный с юмором и настоящей любовью к жизни", rating: 5, badge: "❤ Любимое" },
];

const GENRES = ["Все", "Классика", "Современная"];
